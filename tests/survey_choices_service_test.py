...
class TestSurveyChoicesService(unittest.TestCase):
    ...
    def test_get_list_of_survey_choices_returns_correct_choice_names(self):
        ...
        """
        choices = scs.get_list_of_survey_choices(self.survey_id)
        self.assertEqual(choices[0][2] + " " + choices[1][2], "Esimerkkipäiväkoti 1 Esimerkkipäiväkoti 2")
    ...
    def test_get_choice_additional_infos_returns_correct_data(self):
        ...
        # headers
        self.assertEqual(choice_infos[0][0] + " " + choice_infos[1][0], "Osoite Postinumero")
        # info
        self.assertEqual(choice_infos[0][1] + " " + choice_infos[1][1], "Keijukaistenpolku 14 00820")
