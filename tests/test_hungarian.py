...
def setup_env(setup_db):
    ...
    setup_db["groups"] = groups
    setup_db["students"] = students
    setup_db["weights"] = weights
    setup_db["h"] = h
    setup_db["original_matrix"] = original_matrix
    setup_db["original_assigned_groups_dict"] = original_assigned_groups_dict
    setup_db["original_student_happiness"] = original_student_happiness
    setup_db["reshaped_matrix"] = reshaped_matrix
