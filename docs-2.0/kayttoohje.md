...
![](images/number_of_prioritized_groups.png)
...
Annetut lisätiedot tulevat vastaajalle näkyviin vaihtoehtoa klikatessa:
...
- Tarkemmat ohjeet vaihtoehtojen tuomiseen csv-tiedostosta löytyy täältä: [csv-ohje](../frontend/public/content/csv-instructions-fi.md)
...
Monivaiheisen kyselyn luominen alkaa etusivun "Luo uusi kysely"-nappia painamalla. Kyselyn luominen alkaa etusivun "Luo uusi kysely"-nappia painamalla. Sovellus avaa lomakkeen, jonka useimmat kohdat täytetään samaan tapaan kuin tavallisessa kyselyssä. 
Lomakkessa on kuitenkin lisäksi lomakkeessa on seuraavat lisäkohdat:

##### Sallitaanko poissaolot?
...
## 2.1 Vaiheiden hallinta ##
 
##### 2.1.1 Vaiheen lisääminen
...
##### 2.1.3 Vaihtoehtojen lisääminen vaiheeseen
...
### Ryhmäjako, kun vastauksia on enemmän kuin paikkoja
...
##### 5.3 Vaiheet monivaiheisessa kyselyssä

- Vaiheet on listattu kyselyn nimen ja lisätietojen alla.
- Vaiheiden välillä voi navigoida klikkaamalla vaiheen tunnistetta.
- Vastaajan tulee vastata jokaiseen vaiheeseen samaan tapaan kuin tavallisessa kyselyssä.

###### 5.3.1 Poissaolot
- Jos kyselyn luoja on sallinut poissaolot, voit ilmoittautua poissaolevaksi valitsemistasi vaiheista klikkaamassa vaiheen yläreunassa olevaa kohtaa "En ole paikalla tässä vaiheessa"
